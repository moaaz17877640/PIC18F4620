...
# 13 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 1
# 12 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h"
# 1 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Std_Libraries.h" 1
# 12 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Std_Libraries.h"
...
# 12 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
...
# 13 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
...
# 14 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Std_Libraries.h" 2
# 12 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 2

# 1 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../compiler.h" 1
# 11 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../compiler.h"
...
# 11 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../compiler.h" 2
# 13 "MCAL_Layer/TIMER1/../../MCAL_Layer/GPIO/../Mcal_Std_Types.h" 2
...
static __attribute__((inline)) void MODE_configure(const Timer1_t *TMR );
static __attribute__((inline)) void register_configure(const Timer1_t *TMR );
static __attribute__((inline)) void OSC_configure(const Timer1_t *TMR );

static void (*TIMER1_INTERRUPPT_HANDLERF)(void)= ((void*)0);
...
Std_ReturnType TMR1_Init(const Timer1_t *TMR){
    ...
    }else
    {
        ...
        OSC_configure(TMR);
        (T1CONbits.T1CKPS = TMR->Prescaler_value);
...
# 54 "MCAL_Layer/TIMER1/hal_timer1.c"
        (INTCONbits.PEIE = 1);
        (INTCONbits.GIE = 1);
...
Std_ReturnType TMR1_Read_value(const Timer1_t *TMR , uint16 *value){
  Std_ReturnType ret = (Std_ReturnType)0x00 ;
  uint8 l_tmr =(0) ,h_tmr = (0) ;
    if((((void*)0) == TMR)&& (((void*)0) == value)){
        ret =(Std_ReturnType)0x00 ;
    }else
    {
      l_tmr =TMR1L ;
...
static __attribute__((inline)) void MODE_configure(const Timer1_t *TMR ){
    if(1 == TMR->timer1_mode)
    {
    (T1CONbits.TMR1CS = 1 );
     if(0 == TMR->counter_mode){
    (T1CONbits.T1SYNC = 0) ;
    }
    else if(1 == TMR->counter_mode){
     (T1CONbits.T1SYNC = 1) ;
    }else{

    }
    }
    else if(0 == TMR->timer1_mode)
    {
    (T1CONbits.TMR1CS = 0 );
    }
    else { }
...
static __attribute__((inline)) void register_configure(const Timer1_t *TMR ){
    if(1 == TMR->timer1_register_size){
    (T1CONbits.RD16 = 1) ;
    }else if(0 == TMR->timer1_register_size){
    (T1CONbits.RD16 = 0) ;
    }else {
...
static __attribute__((inline)) void OSC_configure(const Timer1_t *TMR ){
    if(1 == TMR->timer1_osc_cfg){
        (T1CONbits.T1OSCEN = 1);

    }else if(0 == TMR->timer1_osc_cfg){
    (T1CONbits.T1OSCEN = 0);
    }
    else {
