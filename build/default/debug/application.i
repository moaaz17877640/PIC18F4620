...
# 1 "./ECU_Layer/BUTTON/ecu_botton.h" 1
# 21 "./ECU_Layer/BUTTON/ecu_botton.h"
typedef enum{
    BUTTON_PRESSED ,
            BUTTON_RELEASED
}button_state_t;
...
# 1 "./ECU_Layer/RELAY/relay_ecu.h" 1
# 18 "./ECU_Layer/RELAY/relay_ecu.h"
typedef struct {
    uint8 relay_port : 4 ;
    uint8 relay_pin : 3 ;
...
# 41 "./MCAL_Layer/TIMER0/hal_timer0.h"
typedef enum{
    PRESCALER_DIV_2,
             PRESCALER_DIV_4,
             PRESCALER_DIV_8,
...
# 38 "./MCAL_Layer/TIMER3/hal_timer3.h"
typedef enum{
...
ccp_t ccp_obj ;
void ccp_init(void){
ccp_obj.CCP1_INTERRUPT_HANDLER =((void*)0) ;
ccp_obj.CCP2_INTERRUPT_HANDLER = ((void*)0) ;
ccp_obj.CCP_Mode = CCP_MODULE_CAPTURE_MODE ;
ccp_obj.Sub_mode = (uint8)(0x02) ;
...
int1.TIMER1_INTERRUPT_HANDLER = ((void*)0) ;

int1.timer1_mode = 0 ;
int1.timer1_osc_cfg = 0 ;
int1.timer1_preload_value = 0 ;
int1.timer1_register_size = 1 ;
TMR1_Init(&int1);
}
void TMR_ISR(void){
